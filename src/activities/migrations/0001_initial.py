...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='LatestActivityPlugin',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='activities_latestactivityplugin', serialize=False, to='cms.CMSPlugin')),
                ('latest_activities', models.IntegerField(default=5, help_text='The max number of latest activities to display.')),
            ],
            options={
                'abstract': False,
            },
